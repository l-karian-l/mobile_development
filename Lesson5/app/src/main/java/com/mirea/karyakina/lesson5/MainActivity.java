package com.mirea.karyakina.lesson5;
...
import com.mirea.karyakina.lesson5.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Список для отображения в ListView найденных датчиков
        ...
        // создаем адаптер и устанавливаем тип адаптера - отображение 2х полей
